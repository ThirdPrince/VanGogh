...
import com.vangogh.media.utils.SystemUtil;


/**
 * Created by Martin on 2017/1/17.
 */
public class NumCheckBox extends View {
  ...
  public NumCheckBox(Context context, AttributeSet attrs) {
    this(context, attrs, 0);
  }

  public NumCheckBox(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    normalColor =
        a.getColor(R.styleable.CheckBox_checkbox_color,
            getResources().getColor(R.color.green_color_20c064));
    unCheckedColor =
