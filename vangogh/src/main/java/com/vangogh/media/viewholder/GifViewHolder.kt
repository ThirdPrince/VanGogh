 ...
 * @Version 1.0
 */
class GifViewHolder(var view:View,   onMediaItemClickListener:OnMediaItemClickListener): ImageViewHolder(view,onMediaItemClickListener), View.OnClickListener{
